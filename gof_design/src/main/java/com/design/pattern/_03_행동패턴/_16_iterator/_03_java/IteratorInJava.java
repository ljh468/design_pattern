...
import com.design.pattern._03_행동패턴._16_iterator._02_after.Board;
...
public class IteratorInJava {
  ...
  public static void main(String[] args) throws FileNotFoundException, XMLStreamException {
    ...
    // forEachRemaining은 Consumer 인터페이스를 받음 (람다식으로 대체가능)
    ...
    XMLEventReader reader = xmlInputFactory.createXMLEventReader(new FileInputStream("gof_design/src/main/java/com/design/pattern/_03_행동패턴/_16_iterator/Book.xml"));
